...
public static boolean gameInsert(String name,String discription,String uploadPath,String link) {
		...
		try {
			...
			String sql="INSERT INTO games(gameId,gameName,discription,gameImage,gameLink) VALUES(0,'"+name+"','"+discription+"','"+uploadPath+"','"+link+"')";
...
public static boolean gameDataUpdate(String id,String name,String discription,String link) {
	...
	try {
		...
		conn=connection.getConnection();
		stmt=conn.createStatement();
		String sql = "update games set gameName='"+name+"',discription='"+discription+"',gameLink='"+link+"' WHERE gameId='"+conID+"'";
